...
namespace TrafficSimulation
{
    ...
    public class IntersectionEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            SerializedProperty vehiclesQueue = serializedObject.FindProperty("vehiclesQueue");
            SerializedProperty vehiclesInIntersection = serializedObject.FindProperty("vehiclesInIntersection");
            EditorGUILayout.PropertyField(vehiclesQueue, new GUIContent("vehiclesQueue"), true);
            EditorGUILayout.PropertyField(vehiclesInIntersection, new GUIContent("vehiclesInIntersection"), true);
            serializedObject.ApplyModifiedProperties();
